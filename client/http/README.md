...
It complies with the [go-micro.Client](https://godoc.org/github.com/asim/nitro/client#Client) interface.
...
```go
import "github.com/asim/nitro-plugins/client/http"
...
```go
import _ "github.com/asim/nitro-plugins/client/http"
```
